...
var server_SuperServerComponent = $hx_exports["server"]["SuperServerComponent"] = function() {
};
server_SuperServerComponent.__name__ = true;
server_SuperServerComponent.prototype = {
	saySomething: function(phrase) {
		console.log("src/hx/server/SuperServerComponent.hx:12:",phrase);
