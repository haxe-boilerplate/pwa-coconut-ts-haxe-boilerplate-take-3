...
var client_ui__$TestReactUI_TestReactUI_$Impl_$ = function() { };
client_ui__$TestReactUI_TestReactUI_$Impl_$.__name__ = true;
client_ui__$TestReactUI_TestReactUI_$Impl_$.fromHxx = function(props) {
	return React.createElement(react__$ReactType_ReactType_$Impl_$.fromComp(client_ui_TestReactUI),props);
};
var React_Component = require("react").Component;
var client_ui_TestReactUI = require("./ui/TestReactUI").default;
...
client_ui_ThingsView.prototype = $extend(coconut_ui_View.prototype,{
	coconutRender: function() {
		...
		var __ret3 = { };
		__r1.push(React.createElement(react__$ReactType_ReactType_$Impl_$.fromComp(client_ui_TestReactUI),__ret3));
		var __ret4 = { };
		__r.push(coconut_react_Html.h("div",__ret4,__r1));
		return __r[0];
	}
	,get_thing: function() {
	...
	,__class__: client_ui_ThingsView
});
